...
class functions
{
    ...
    public static function html_input_edit($label, $input, $value, $classes = "", $attributes = "")
    {
        ...
        $html .= '<input type="text" class="form-control ' . $classes . '" name="' . $input . '" value="' . $value . '" placeholder="' . sanitize_html_class(strip_tags($label)) . '" ' . $attributes . '>';
        $html .= '</div>';
        return $html;
    }
    ...
    public static function html_number_edit($label, $input, $value, $classes = "", $attributes = "")
    {
        ...
        $html .= '<div class="form-group">';
        $html .= '<label>' . $label . '</label>';
        $html .= '<input type="number" class="form-control ' . $classes . '" name="' . $input . '" value="' . $value . '" placeholder="' . sanitize_html_class(strip_tags($label)) . '" ' . $attributes . '>';
        $html .= '</div>';
        return $html;
    }
    ...
    public static function html_textarea_edit($label, $input, $value, $classes = "", $attributes = "")
    {
        ...
        $html .= '<div class="form-group">';
        $html .= '<label>' . $label . '</label>';
        $html .= '<textarea class="form-control ' . $classes . '" name="' . $input . '" placeholder="' . sanitize_html_class(strip_tags($label)) . '" ' . $attributes . '>' . $value . '</textarea>';
        $html .= '</div>';
        return $html;
    }
